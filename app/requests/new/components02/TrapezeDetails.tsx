...
const TrapezeDetails = () => {
  ...
  const [materialStrengthLimit, setMaterialStrengthLimit] = useState<string>('');
  ...
  return (
    <div className='flex flex-col gap-2'>
      <div className='grid gap-2 grid-cols-2'>
        <Select value={selectedMaterial} onChange={(choice) => handleTrapezeMaterialChange(choice as string)} label="Material">
          <Option value="aluminium">Aluminium</Option>
          <Option value="steel">Stahl</Option>
        </Select>
        <Select label="Stärke">
          <Option value="big">größer/gleich {materialStrengthLimit}mm Stärke</Option>
          <Option value="small">kleiner {materialStrengthLimit}mm Stärke</Option>
        </Select>
      </div>
      <Checkbox id="icopal" label={(
